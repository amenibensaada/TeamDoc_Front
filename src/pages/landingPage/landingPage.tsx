            ...
            <div className="container mx-auto px-8 lg:flex">
              ...
              <div className="lg:w-1/2">
                <svg
                  ...
                  <path
                    fill="#ededf4"
                    d="M371.93 199.71h94v10h-94zM371.93 228.71h528v10h-528zM371.93 257.71h528v10h-528zM371.93 286.71h528v10h-528zM371.93 315.71h528v10h-528zM95.93 199.71h94v10h-94zM95.93 228.71h94v10h-94zM95.93 257.71h94v10h-94zM95.93 286.71h94v10h-94zM95.93 315.71h94v10h-94z"></path>
                  <path
                    transform="rotate(90 670.53 129.08)"
                    fill="url(#b)"
                    d="M640.17 170.69h4v6h-4z"></path>
                  <path
                  ...
                  <path
                    fill="#4299e1"
                    d="M768.43 719.66l11.19-7.04 120.8-1.04 3.11 8.08h-135.1z"></path>
                  <path
                    fill="#3f3d56"
                    d="M768.43 727.12v-7.46l137.29-1.32-.13 5.05H770.91v3.73h-2.48z"></path>
                  <circle
                    cx="785.83"
                    cy="741.63"
                    r="12.43"
                  ...
                  <path
                    opacity=".1"
                    d="M258.205 656.217l-79.962 18.167-18.167-79.962 79.962-18.167z"></path>
                  <path
                    fill="#ededf4"
                    d="M259.704 653.832l-79.962 18.167-18.167-79.962 79.962-18.167z"></path>
                  <path
              ...
              <div className="mt-10 lg:mt-0 w-full lg:w-1/2 undefined">
                <svg
                  ...
                  <path
                    ...
                    stroke-width="7"
                    d="M318.5 385.41l130-145 130 73 130-224 130 107"></path>
                ...
                <div className="flex-1 px-3">
                  <div
                    ...
                    <p className="mt-6">
                      ...
                      blandit massa. Sit amet consectetur adipiscing elit duis.
                    </p>
