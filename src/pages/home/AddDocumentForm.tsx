    ...
    <div className="add-document-form">
      <form
        ...
        <input
          ...
          className=" text-white w-full px-4 py-2 mb-4 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500"
        />
        <textarea
          name="contentType"
          ...
          onChange={handleInputChange}
          className="w-full text-white px-4 py-2 mb-4 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500"></textarea>
        <button
          type="submit"
          className="w-full px-4 py-2 bg-blue-500 text-white rounded-md focus:outline-none focus:bg-blue-600 hover:bg-blue-600">
          Add Document
        </button>
      </form>
    </div>
