        ...
        <div className="grid gap-2">
          ...
          <div className="relative">
            <textarea
              ...
              className="block w-full rounded-md border border-gray-300 px-4 py-3 text-gray-900 placeholder-gray-500 focus:border-gray-500 focus:ring-gray-500 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 dark:placeholder-gray-400 dark:focus:border-gray-500 dark:focus:ring-gray-500"
              value={transcript}
            ></textarea>
            {isListening && (
              <button
